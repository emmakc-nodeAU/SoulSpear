...
void ShaderClassApp::update(float deltaTime) {
...
void ShaderClassApp::CreateCube()
{
	/*
	STEP 1: 
...
void ShaderClassApp::DestroyCube()
{
...
void ShaderClassApp::CreateGrid()
{
	/*
	STEP 1:
...
void ShaderClassApp::DestroyGrid()
{
...
void ShaderClassApp::LoadShader()
{
	// SHADER: Vertex
...
void ShaderClassApp::UnloadShader()
{
