...
TyphoonLabs::TyphoonLabs() {}

TyphoonLabs::~TyphoonLabs() {}

bool TyphoonLabs::startup() {
...
void TyphoonLabs::update(float deltaTime) {
...
void TyphoonLabs::RenderMesh(GLMesh *mesh, glm::vec3 &position, glm::vec3 &scale, glm::vec3 materialColour, aie::Texture *diffuseTexture)
{
	glm::mat4 model(
		scale.x, 0, 0, 0,
		0, scale.y, 0, 0,
...
void TyphoonLabs::UnloadShader()
{
	//delete m_shaderProgram;
}

void TyphoonLabs::soulSpear()
{
	// Shader SoulSpear
	glUseProgram(m_shaderSoulSpear->GetProgramID());
