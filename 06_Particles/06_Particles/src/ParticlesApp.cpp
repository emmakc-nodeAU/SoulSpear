...
void ParticlesApp::update(float deltaTime) {
...
void ParticlesApp::RenderMesh(GLMesh *mesh, glm::vec3 &position, glm::vec3 &scale, glm::vec3 materialColour, aie::Texture *diffuseTexture)
{
	glm::mat4 model(
		scale.x, 0, 0, 0,
		0, scale.y, 0, 0,
...
void ParticlesApp::UnloadShader()
{
